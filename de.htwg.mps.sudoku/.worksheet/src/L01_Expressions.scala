object L01_Expressions {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(64); val res$0 = 
  // Simple Expressions
  1 + 2 + 3 + 4;System.out.println("""res0: Int = """ + $show(res$0));$skip(18); val res$1 = 
