...
object L10_Monads {import scala.runtime.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(80); 
  println("Welcome to the Scala worksheet");$skip(32); 
  
  def isEven(x:Int) = x%2==0;System.out.println("""isEven: (x: Int)Boolean""");$skip(75); val res$0 = 
  ...
  var list = List(1,2,3,4);System.out.println("""list  : List[Int] = """ + $show(list ));$skip(28); val res$2 = 
	...
	val pack = new Pack(List(new Bottle, new Bottle, new Bottle, new Bottle));System.out.println("""pack  : de.htwg.L10_Monads.Pack = """ + $show(pack ));$skip(39); val res$7 = 
	
  pack.map(bottle => bottle.consume);System.out.println("""res7: List[de.htwg.L10_Monads.Bottle] = """ + $show(res$7));$skip(53); val res$8 = 
	
	for (bottle <- pack.bottles) yield bottle.consume;System.out.println("""res8: List[de.htwg.L10_Monads.Bottle] = """ + $show(res$8));$skip(83); 
  ...
  val pack1 = new Pack(List(new Bottle, new Bottle, new Bottle, new Bottle));System.out.println("""pack1  : de.htwg.L10_Monads.Pack = """ + $show(pack1 ));$skip(76); 
	...
	};System.out.println("""consumeAllWithFor: (crate: de.htwg.L10_Monads.Crate)List[de.htwg.L10_Monads.Bottle]""");$skip(27); val res$9 = 
 consumeAllWithFor(crate1);System.out.println("""res9: List[de.htwg.L10_Monads.Bottle] = """ + $show(res$9));$skip(79); 
...
};System.out.println("""consumeAllAssumeNullWithFor: (pack: de.htwg.L10_Monads.PackT[Option[de.htwg.L10_Monads.Bottle]])List[Any]""");$skip(35); val res$10 = 
consumeAllAssumeNullWithFor(pack5);System.out.println("""res10: List[Any] = """ + $show(res$10))}
